    ...
    <DialogPrimitive.Portal>
      ...
      >
        ...
        <DialogPrimitive.CloseButton
          class="absolute right-4 top-4 flex rounded-sm opacity-70 b-0 ring-offset-background transition-opacity hover:opacity-100 focus:(outline-none ring-1.5 ring-ring ring-offset-2) disabled:pointer-events-none bg-inherit transition-property-[opacity,box-shadow]"
        >
          <svg
            class="h-4 w-4"
            viewBox="0 0 24 24"
