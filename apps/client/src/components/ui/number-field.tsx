...
>(
  ...
  return (
    <NumberFieldPrimitive.DecrementTrigger
      class={cn(
        'absolute top-1/2 -translate-y-1/2 left-0 p-3 bg-transparent disabled:(cursor-not-allowed opacity-20)',
        local.class
      )}
      {...rest}
    >
...
>(
  ...
  return (
    <NumberFieldPrimitive.IncrementTrigger
      class={cn(
        'absolute top-1/2 -translate-y-1/2 bg-transparent right-0 disabled:(cursor-not-allowed opacity-20) p-3',
        local.class
      )}
      {...rest}
    >
