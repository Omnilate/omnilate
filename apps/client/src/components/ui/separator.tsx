...
export const Separator = <T extends ValidComponent = 'hr'>(
  ...
  return (
    <SeparatorPrimitive
      class={cn(
        'shrink-0 bg-border b-0 data-[orientation=horizontal]:h-[1px] data-[orientation=vertical]:h-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-[1px]',
        local.class
      )}
      {...rest}
    />
