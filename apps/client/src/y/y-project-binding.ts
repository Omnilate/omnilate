import type { AwarenessInfo, Discussion, I18Next, I18NextRecord, ProjectChatMessage, ProjectDirectory, ProjectDirectoryY, ProjectFile, ProjectStructure } from '@omnilate/schema'
